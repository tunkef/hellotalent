-- ═══════════════════════════════════════════════════════════════
-- Migration: Add shift_flexibility + notice_period to work preferences
-- Date: 2026-04-04
-- Reason: AP3 vardiya esnekliği + AP4 ihbar süresi
-- ═══════════════════════════════════════════════════════════════
...
-- 2. Update save_candidate_profile — work prefs now includes shift_flexibility + notice_period
