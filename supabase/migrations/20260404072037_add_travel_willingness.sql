-- ═══════════════════════════════════════════════════════════════
-- Migration: Add travel_willingness to candidate_work_preferences
-- Date: 2026-04-04
-- Reason: Apple benchmark AKS-3 — seyahat isteği alanı
--         Bölge müdürü pozisyonlarında kritik filtre
-- ═══════════════════════════════════════════════════════════════
...
-- 2. Update save_candidate_profile — work prefs section now includes travel_willingness
...
BEGIN
  ...
  IF p_work_prefs IS NOT NULL THEN
    INSERT INTO candidate_work_preferences (
      ...
      segmentler, career_goal, career_type, travel_willingness
    )
    VALUES (
      v_candidate_id,
