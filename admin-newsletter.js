...
(function(){
  ...
  function renderCompose() {
    ...
    setHtml(container, ''
      ...
      + '  <div style="margin-bottom:16px;padding:14px 16px;background:#FEF3C7;border:1px solid #FCD34D;border-radius:10px;font-size:13px;color:#78350F;line-height:1.55;">'
      + '    <div style="font-weight:700;margin-bottom:4px;">İçerik üretim protokolü (K012)</div>'
      + '    Bu composer\'a <strong>elle yazılmış içerik</strong> girilmez. Her kampanya <code>marketing-writer</code> ajanı tarafından <code>avoid-ai-writing</code> skill audit\'iyle üretilir, <code>content-writer</code> + <code>legal-reviewer</code> peer check\'inden geçer. chief-of-staff\'tan hazır markdown\'ı buraya yapıştır. <strong>Fabrikasyon yasak</strong> — uydurma stat/case/alıntı.'
      + '  </div>'
      ...
      + '    <textarea id="nl-c-body" rows="16" placeholder="marketing-writer ajanından alınan markdown içeriği buraya yapıştır.&#10;&#10;Örnek:&#10;## Başlık&#10;&#10;Paragraf metin...&#10;&#10;- Madde 1&#10;- Madde 2&#10;&#10;**Kalın**, *italik*, [Link](https://...) destekli.&#10;&#10;⚠ Elle yazma — chief-of-staff üstünden marketing-writer + avoid-ai-writing audit + legal-reviewer peer check akışından geçir." style="width:100%;padding:10px;border:1px solid var(--border);border-radius:8px;font-family:monospace;font-size:13px;line-height:1.5;"></textarea>'
      + '  </div>'
