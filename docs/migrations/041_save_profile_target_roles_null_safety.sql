-- 041: save_candidate_profile — target_roles null safety
-- candidate_target_roles.rol_ailesi / rol_unvani NOT NULL; insert only rows
-- where both are non-null and non-empty to avoid constraint violation from
-- legacy clients or partial form data.
--
-- RUN: If your DB already had 001 applied, run this entire file in
