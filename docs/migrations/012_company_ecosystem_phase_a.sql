...
--   This file creates brands with `name` and companies with `name`.
--   Production has since been renamed to `brand_name` and `company_name`.
--   Fresh install order: 012 → 012a → 046_brands_column_reconciliation.sql
--   DO NOT edit this file — 046 renames the columns idempotently after seed.
-- ═══════════════════════════════════════════════════════════════
