...
function injectCSS() {
  /* CSS now loaded via <link> in profil.html — see css/studio.css */
}
...
/* ── Coach state + labels + trLowerCoach: MOVED → profil-studio-coach.js (K044) ── */
...
/* ── SVG constants + hydrateCoachFeed + render/detail/like: MOVED → profil-studio-coach.js (K044) ── */
