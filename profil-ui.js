...
var _BRAND_COLORS = {
  'Louis Vuitton': { frontBg: 'radial-gradient(ellipse at 50% -20%, #ead5b8 0%, #f2e6d5 65%, #fff 100%)', backBg: 'linear-gradient(160deg, #7d5c35 0%, #614626 40%, #44301a 100%)', accent: '#6B4C2A' },
  'Gucci': { frontBg: 'radial-gradient(ellipse at 50% -20%, #c8e6ca 0%, #e0f0e2 65%, #fff 100%)', backBg: 'linear-gradient(160deg, #00714a 0%, #005c3a 40%, #003d26 100%)', accent: '#00613C' },
  'Prada': { frontBg: 'radial-gradient(ellipse at 50% -20%, #d8d8d8 0%, #eaeaea 65%, #fff 100%)', backBg: 'linear-gradient(160deg, #2a2a2a 0%, #1a1a1a 40%, #0d0d0d 100%)', accent: '#1A1A1A' },
  'Hermès': { frontBg: 'radial-gradient(ellipse at 50% -20%, #f8c8a0 0%, #fce0c8 65%, #fff 100%)', backBg: 'linear-gradient(160deg, #e86218 0%, #c44e0e 40%, #9a3d0a 100%)', accent: '#E35205' },
  'Dior': { frontBg: 'radial-gradient(ellipse at 50% -20%, #d8d8d8 0%, #eaeaea 65%, #fff 100%)', backBg: 'linear-gradient(160deg, #2a2a2a 0%, #1a1a1a 40%, #0d0d0d 100%)', accent: '#1A1A1A' },
  'Chanel': { frontBg: 'radial-gradient(ellipse at 50% -20%, #dadada 0%, #ececec 65%, #fff 100%)', backBg: 'linear-gradient(160deg, #2a2a2a 0%, #1a1a1a 40%, #0d0d0d 100%)', accent: '#1A1A1A' },
  'Cartier': { frontBg: 'radial-gradient(ellipse at 50% -20%, #f0c0b4 0%, #f8ddd4 65%, #fff 100%)', backBg: 'linear-gradient(160deg, #b82030 0%, #961a28 40%, #70131e 100%)', accent: '#A8182D' },
  'Beymen': { frontBg: 'radial-gradient(ellipse at 50% -20%, #ddd0be 0%, #ebe2d4 65%, #fff 100%)', backBg: 'linear-gradient(160deg, #9e8465 0%, #7d6748 40%, #5c4a33 100%)', accent: '#8B7355' },
  'Vakko': { frontBg: 'radial-gradient(ellipse at 50% -20%, #d5d5d5 0%, #e6e6e6 65%, #fff 100%)', backBg: 'linear-gradient(160deg, #3a3a3a 0%, #2a2a2a 40%, #1a1a1a 100%)', accent: '#2C2C2C' },
  'Massimo Dutti': { frontBg: 'radial-gradient(ellipse at 50% -20%, #e0d4c4 0%, #ede5d8 65%, #fff 100%)', backBg: 'linear-gradient(160deg, #5e4430 0%, #4a3524 40%, #36271a 100%)', accent: '#4A3728' },
  'Hugo Boss': { frontBg: 'radial-gradient(ellipse at 50% -20%, #d8d8d8 0%, #eaeaea 65%, #fff 100%)', backBg: 'linear-gradient(160deg, #2a2a2a 0%, #1a1a1a 40%, #0d0d0d 100%)', accent: '#1A1A1A' },
  'Ralph Lauren': { frontBg: 'radial-gradient(ellipse at 50% -20%, #c4d0e8 0%, #d8e0f0 65%, #fff 100%)', backBg: 'linear-gradient(160deg, #264d82 0%, #1d3d68 40%, #142c4d 100%)', accent: '#1B3D6D' },
  'Lacoste': { frontBg: 'radial-gradient(ellipse at 50% -20%, #b8e0c4 0%, #d4edda 65%, #fff 100%)', backBg: 'linear-gradient(160deg, #006838 0%, #005228 40%, #003d1e 100%)', accent: '#004D2C' },
  'Alo Yoga': { frontBg: 'radial-gradient(ellipse at 50% -20%, #e4d4b8 0%, #f0e6d0 65%, #fff 100%)', backBg: 'linear-gradient(160deg, #d4b070 0%, #b89555 40%, #96793e 100%)', accent: '#C4A265' },
  'lululemon': { frontBg: 'radial-gradient(ellipse at 50% -20%, #f0b8b8 0%, #fcd8d8 65%, #fff 100%)', backBg: 'linear-gradient(160deg, #e01a3e 0%, #be1534 40%, #961028 100%)', accent: '#D31334' },
  'Nike': { frontBg: 'radial-gradient(ellipse at 50% -20%, #d8d8d8 0%, #eaeaea 65%, #fff 100%)', backBg: 'linear-gradient(160deg, #2a2a2a 0%, #1a1a1a 40%, #0d0d0d 100%)', accent: '#111111' },
  'Adidas': { frontBg: 'radial-gradient(ellipse at 50% -20%, #d8d8d8 0%, #eaeaea 65%, #fff 100%)', backBg: 'linear-gradient(160deg, #2a2a2a 0%, #1a1a1a 40%, #0d0d0d 100%)', accent: '#1A1A1A' },
  'Zara': { frontBg: 'radial-gradient(ellipse at 50% -20%, #dadada 0%, #ececec 65%, #fff 100%)', backBg: 'linear-gradient(160deg, #2a2a2a 0%, #1a1a1a 40%, #0d0d0d 100%)', accent: '#1A1A1A' },
  'H&M': { frontBg: 'radial-gradient(ellipse at 50% -20%, #ffb8b8 0%, #ffd6d6 65%, #fff 100%)', backBg: 'linear-gradient(160deg, #e52020 0%, #c41515 40%, #9a0e0e 100%)', accent: '#E50010' },
  'Mango': { frontBg: 'radial-gradient(ellipse at 50% -20%, #e4d4b8 0%, #f0e6d0 65%, #fff 100%)', backBg: 'linear-gradient(160deg, #d4b078 0%, #b8955d 40%, #967944 100%)', accent: '#C8A96E' },
  'Boyner': { frontBg: 'radial-gradient(ellipse at 50% -20%, #b8d4ea 0%, #d4e4f0 65%, #fff 100%)', backBg: 'linear-gradient(160deg, #0070b0 0%, #005a8e 40%, #00446b 100%)', accent: '#005B96' },
  'Pull & Bear': { frontBg: 'radial-gradient(ellipse at 50% -20%, #c8dcc4 0%, #dde8d8 65%, #fff 100%)', backBg: 'linear-gradient(160deg, #587e4e 0%, #46643d 40%, #354c2e 100%)', accent: '#4A6741' },
  'Bershka': { frontBg: 'radial-gradient(ellipse at 50% -20%, #dadada 0%, #ececec 65%, #fff 100%)', backBg: 'linear-gradient(160deg, #2a2a2a 0%, #1a1a1a 40%, #0d0d0d 100%)', accent: '#1A1A1A' },
  'Stradivarius': { frontBg: 'radial-gradient(ellipse at 50% -20%, #e0d4c4 0%, #ede5d8 65%, #fff 100%)', backBg: 'linear-gradient(160deg, #9e7d55 0%, #7d6342 40%, #5e4a30 100%)', accent: '#8B6F47' },
  'Zara Home': { frontBg: 'radial-gradient(ellipse at 50% -20%, #ddd6cc 0%, #eae5de 65%, #fff 100%)', backBg: 'linear-gradient(160deg, #7e6e5e 0%, #645648 40%, #4c4035 100%)', accent: '#6B5B4E' },
  'LC Waikiki': { frontBg: 'radial-gradient(ellipse at 50% -20%, #f0b8b8 0%, #fcd8d8 65%, #fff 100%)', backBg: 'linear-gradient(160deg, #f05545 0%, #d44535 40%, #aa3628 100%)', accent: '#E74C3C' },
  'Sephora': { frontBg: 'radial-gradient(ellipse at 50% -20%, #dadada 0%, #ececec 65%, #fff 100%)', backBg: 'linear-gradient(160deg, #2a2a2a 0%, #1a1a1a 40%, #0d0d0d 100%)', accent: '#1A1A1A' },
  'MAC': { frontBg: 'radial-gradient(ellipse at 50% -20%, #dadada 0%, #ececec 65%, #fff 100%)', backBg: 'linear-gradient(160deg, #2a2a2a 0%, #1a1a1a 40%, #0d0d0d 100%)', accent: '#1A1A1A' },
  'Apple': { frontBg: 'radial-gradient(ellipse at 50% -20%, #dcdce0 0%, #ebebed 65%, #fff 100%)', backBg: 'linear-gradient(160deg, #444 0%, #333 40%, #1a1a1a 100%)', accent: '#333333' },
  'Samsung': { frontBg: 'radial-gradient(ellipse at 50% -20%, #c0c8ee 0%, #d8e0f8 65%, #fff 100%)', backBg: 'linear-gradient(160deg, #1e38b8 0%, #162c96 40%, #0f2070 100%)', accent: '#1428A0' },
  'Teknosa': { frontBg: 'radial-gradient(ellipse at 50% -20%, #f0b8b8 0%, #fcd8d8 65%, #fff 100%)', backBg: 'linear-gradient(160deg, #f01820 0%, #cc1018 40%, #a00c12 100%)', accent: '#E30613' }
};

function _brandColors(brandName) {
  return _BRAND_COLORS[brandName] || {
    frontBg: 'radial-gradient(ellipse at 50% -20%, #eee 0%, #f5f5f5 65%, #fff 100%)',
