...
(function () {
  ...
  var FOOTER_HTML = [
    ...
    '    </div>',
    '    <div>',
    '      <div class="footer-col-title">İşe Alım</div>',
    '      <a class="footer-link" href="isalim-rotasi.html">İşe Alım Rotaları</a>',
    '      <a class="footer-link" href="isveren.html">İşveren Kaydı</a>',
    '    </div>',
