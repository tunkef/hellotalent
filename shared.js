...
(function () {
  ...
  var HEADER_HTML = [
    ...
    '<a class="nav-link' + (PAGE === 'aday' ? ' active active-aday' : '') + '" href="' + segHref('adaylar') + '"' + segClick('adaylar') + '>Adaylar</a>',
    '<a class="nav-link' + (PAGE === 'kurumsal' || PAGE === 'isveren' ? ' active active-isveren' : '') + '" href="' + segHref('kurumsal') + '"' + segClick('kurumsal') + '>Kurumsal</a>',
    '  </nav>',
    ...
    '        <div style="font-size:11px;color:var(--muted);margin-top:6px;">veya <a href="uye-ol.html" style="color:var(--verm);text-decoration:underline;">Kayit ol</a></div>',
    '      </div>',
    ...
    '        <div class="lmc-arrow">&rarr;</div>',
    '        <div style="font-size:11px;color:var(--muted);margin-top:6px;">veya <a href="uye-ol.html?tab=kurumsal" style="color:var(--navy);text-decoration:underline;">Kayit ol</a></div>',
    '      </div>',
    '    </div>',
    '  </div>',
    '</div>',
    ...
    '<a class="mobile-nav-link' + (PAGE === 'aday' ? ' active' : '') + '" href="' + segHref('adaylar') + '"' + segClick('adaylar', true) + '>Adaylar</a>',
    '<a class="mobile-nav-link' + (PAGE === 'kurumsal' || PAGE === 'isveren' ? ' active' : '') + '" href="' + segHref('kurumsal') + '"' + segClick('kurumsal', true) + '>Kurumsal</a>',
  ...
  var FOOTER_HTML = [
    ...
    '      <a class="footer-link" href="' + segHref('adaylar') + '"' + segClick('adaylar') + '>Adaylar</a>',
    '      <a class="footer-link" href="' + segHref('kurumsal') + '"' + segClick('kurumsal') + '>Kurumsal</a>',
